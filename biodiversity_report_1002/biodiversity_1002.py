...
species_type_count = species.category.nunique()
print(species_type_count)
...
conservation_statuses_count = species.conservation_status.nunique()
print(conservation_statuses_count)
...
contingency_amphibian_mammal = [[30, 146], [7, 72]]
...
sample_size_per_variant_y=890

baseline=10
minimum_detectable_effect=100*5/baseline
print(minimum_detectable_effect)
sample_size_per_variant_b=610
...
yellowstone_weeks_observing=sample_size_per_variant_y/507.0
bryce_weeks_observing=sample_size_per_variant_b/250.0
